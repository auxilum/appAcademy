...
function bothStringsIncluded(sentence, word1, word2) {
    console.log(sentence.includes(word1) && sentence.includes(word2));
}

bothStringsIncluded('ja sam bio vani', 'ja', 'bio');
...
countConsonants('ssdddaaeeeeeeeeeeeiiiii');
